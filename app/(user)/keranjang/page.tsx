    ...
    if (items.length === 0) {
        ...
        <main className="min-h-screen bg-gray-50 pt-20 flex items-center justify-center">
            ...
            <Link href="/produk" className="inline-flex items-center gap-2 px-6 py-3 bg-[#2D7D46] text-white font-semibold rounded-xl text-sm hover:bg-[#236338] transition-all">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="lg:col-span-2 space-y-3">
                ...
                <div key={item.id} className="bg-white rounded-2xl border border-gray-100 p-4 flex gap-4">
                    ...
                    <p className="text-base font-bold text-[#2D7D46]">
            ...
            <div className="lg:col-span-1">
                ...
                <div className="flex justify-between text-base font-bold text-gray-900 mb-5 pt-3 border-t border-gray-100">
                    <span>Total</span>
                    <span className="text-[#2D7D46]">Rp {totalPrice().toLocaleString("id-ID")}</span>
                </div>
                <Link
                    href="/checkout"
                    className="w-full py-3.5 bg-[#2D7D46] hover:bg-[#236338] text-white font-semibold rounded-xl text-sm flex items-center justify-center gap-2 transition-all"
                >
