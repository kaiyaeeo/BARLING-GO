    ...
    return (
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
                ...
                <div
                    className="absolute left-4 top-4 w-0.5 bg-[#2D7D46] transition-all"
                ...
                <div className="space-y-5">
                    ...
                    return (
                        ...
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm shrink-0 z-10 border-2 transition-all ${
                            done ? "bg-[#2D7D46] border-[#2D7D46]" : "bg-white border-gray-200"
                        }`}>
                            {done ? <span className="text-white text-xs">✓</span> : <span className="text-gray-400 text-xs">{i + 1}</span>}
                        </div>
                        <div>
                            <p className={`text-sm font-medium ${active ? "text-[#2D7D46]" : done ? "text-gray-700" : "text-gray-400"}`}>
                ...
                <div className="mt-5 pt-4 border-t border-gray-100 flex items-center gap-3">
                    <Truck size={16} className="text-[#2D7D46]" />
                    <div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
                ...
                <Package size={16} className="text-[#2D7D46]" />
                ...
                <div className="flex justify-between font-bold text-base text-gray-900 pt-2 border-t border-gray-100">
                    <span>Total</span>
                    <span className="text-[#2D7D46]">Rp {order.total_amount.toLocaleString("id-ID")}</span>
                </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
                <div className="flex items-center gap-2 mb-4">
                <MapPin size={16} className="text-[#2D7D46]" />
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
                ...
                <CreditCard size={16} className="text-[#2D7D46]" />
