    ...
    return (
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="text-center py-20">
                ...
                <Link href="/produk" className="px-6 py-3 bg-[#2D7D46] text-white font-semibold rounded-xl text-sm hover:bg-[#236338] transition-all">
                Mulai Belanja
                </Link>
            </div>
            ) : (
            <div className="space-y-3">
                ...
                return (
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-gray-50">
                        ...
                        <span className="text-xs text-[#2D7D46] font-medium flex items-center gap-1 group-hover:gap-2 transition-all">
