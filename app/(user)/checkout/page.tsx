        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                    ...
                    <MapPin size={17} className="text-[#2D7D46]" />
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                    <div className="flex items-center gap-2 mb-5">
                    <Truck size={17} className="text-[#2D7D46]" />
                    ...
                    {COURIERS.map((c) => (
                        ...
                        className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${
                            form.courier === c.value ? "border-[#2D7D46] bg-green-50" : "border-gray-200 hover:border-gray-300"
                        }`}
                        >
                        <input
                            type="radio"
                    ...
                    <select
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46] bg-white"
                    >
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                    <div className="flex items-center gap-2 mb-5">
                    <CreditCard size={17} className="text-[#2D7D46]" />
                    ...
                    {PAYMENT_METHODS.map((pm) => (
                        ...
                        className={`flex items-center gap-3 p-3.5 rounded-xl border cursor-pointer transition-all ${
                            form.payment_method === pm.value ? "border-[#2D7D46] bg-green-50" : "border-gray-200 hover:border-gray-300"
                        }`}
                        >
                        <input
                            type="radio"
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5 sticky top-24">
                    ...
                    <span>Total</span>
                    <span className="text-[#2D7D46]">Rp {total.toLocaleString("id-ID")}</span>
                    </div>
                    ...
                    type="submit"
                    disabled={loading}
                    className="w-full py-3.5 bg-[#2D7D46] hover:bg-[#236338] disabled:opacity-60 text-white font-semibold rounded-xl text-sm flex items-center justify-center gap-2 transition-all"
                    >
