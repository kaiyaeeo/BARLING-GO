    ...
    if (loading) {
        ...
        <div className="min-h-screen flex items-center justify-center">
            <Loader2 className="animate-spin text-[#2D7D46]" size={32} />
        </div>
        )
    }
    ...
    if (!order) {
        ...
        <div className="min-h-screen flex items-center justify-center text-center px-6">
            ...
            <Link href="/pesanan" className="mt-4 inline-block text-[#2D7D46] text-sm hover:underline">Lihat semua pesanan</Link>
            </div>
        </div>
        )
    }
    ...
    return (
        ...
        <div className="max-w-lg mx-auto px-4 py-10">
            ...
            <div className="px-6 py-5 space-y-3">
                ...
                <span className="text-[#2D7D46] text-base">Rp {order.total_amount.toLocaleString("id-ID")}</span>
                </div>
            </div>
            ...
            <div className="px-6 pb-6 space-y-3">
                ...
                <button
                    ...
                    className="w-full py-3 border border-[#2D7D46] text-[#2D7D46] font-semibold rounded-xl text-sm flex items-center justify-center gap-2 hover:bg-green-50 transition-all"
                >
