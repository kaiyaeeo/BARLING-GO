    ...
    return (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex-1 min-w-0 space-y-5">
                ...
                {/* Greeting */}
                <div className="bg-gradient-to-r from-[#2D7D46] to-[#4CAF50] rounded-2xl p-6 text-white relative overflow-hidden">
                ...
                <div className="w-12 h-12 rounded-xl bg-[#2D7D46] flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                ...
                <ArrowRight size={16} className="text-gray-300 group-hover:text-[#2D7D46] group-hover:translate-x-1 transition-all" />
                </Link>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                    ...
                    <div className="flex items-center gap-2">
                        <Package size={15} className="text-[#2D7D46]" />
                        <h2 className="text-sm font-bold text-gray-900">Pesanan Terbaru</h2>
                    </div>
                    <Link href="/pesanan" className="text-xs text-[#2D7D46] hover:underline flex items-center gap-1">
                    ...
                    <div className="text-center py-10">
                        ...
                        <Link href="/produk" className="text-xs font-semibold text-[#2D7D46] hover:underline">Mulai Belanja →</Link>
                    </div>
                    ) : (
                ...
                <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                    ...
                    <Link href="/profil/saved" className="text-xs text-[#2D7D46] hover:underline flex items-center gap-1">
                        Lihat semua <ChevronRight size={11} />
                    </Link>
                    </div>
                    ...
                    <div className="text-center py-10">
                        ...
                        <Link href="/wisata" className="text-xs font-semibold text-[#2D7D46] hover:underline">Jelajahi Wisata →</Link>
                    </div>
                    ) : (
                    <div className="divide-y divide-gray-50">
                        ...
                        return (
                            ...
                            <span className="text-[10px] font-semibold bg-green-50 text-[#2D7D46] px-2 py-0.5 rounded-full capitalize">
                                {dest.type}
                            </span>
                            </Link>
                        )
                ...
                {!notifications || notifications.length === 0 ? (
                    ...
                    {notifications.map((n: any) => (
                        ...
                        <div className={`w-2 h-2 rounded-full mt-2 shrink-0 ${!n.is_read ? "bg-[#2D7D46]" : "bg-transparent"}`} />
                        <div className="flex-1 min-w-0">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                    ...
                    <Link href="/profil/ulasan" className="text-xs text-[#2D7D46] hover:underline flex items-center gap-1">
                        Lihat semua <ChevronRight size={11} />
                    </Link>
                    </div>
                    <div className="divide-y divide-gray-50">
