    ...
    return (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex-1 min-w-0">
                {/* Profile header card */}
                <div className="relative bg-gradient-to-r from-[#2D7D46] to-[#4CAF50] rounded-2xl overflow-hidden mb-5" style={{ height: 140 }}>
                ...
                <div className="relative">
                    <div className="w-24 h-24 rounded-full border-4 border-white shadow-lg overflow-hidden bg-[#2D7D46] flex items-center justify-center">
                    {profile?.avatar_url ? (
                ...
                <div className="pb-2">
                    <button className="px-4 py-2 text-sm font-semibold text-[#2D7D46] border border-[#2D7D46] rounded-xl hover:bg-green-50 transition-all flex items-center gap-1.5">
                ...
                <div className="space-y-4">
                    ...
                    {/* Explorer stats */}
                    <div className="bg-[#2D7D46] rounded-2xl p-5">
    ...
    return (
        <div className={`w-10 h-6 rounded-full transition-colors ${enabled ? "bg-[#2D7D46]" : "bg-gray-300"} relative cursor-pointer`}>
