        ...
        <div className="max-w-5xl mx-auto">
            ...
            {activeTab === "keamanan" && (
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-6">
                    ...
                    <Shield size={18} className="text-[#2D7D46]" /> Perbarui Kata Sandi
                    </h2>
                    <div className="space-y-4 max-w-xl">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1.5">Password Lama</label>
                        <input type="password" value={formKeamanan.oldPassword} onChange={e => setFormKeamanan({...formKeamanan, oldPassword: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 outline-none" />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1.5">Password Baru</label>
                        <input type="password" value={formKeamanan.newPassword} onChange={e => setFormKeamanan({...formKeamanan, newPassword: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 outline-none" />
                        </div>
                        <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1.5">Konfirmasi Password Baru</label>
                        <input type="password" value={formKeamanan.confirmPassword} onChange={e => setFormKeamanan({...formKeamanan, confirmPassword: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 outline-none" />
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex items-center justify-between">
                    ...
                    <div className="w-10 h-10 bg-green-50 text-[#2D7D46] rounded-full flex items-center justify-center shrink-0"><Smartphone size={18} /></div>
                    <div>
                    ...
                    <button type="button" onClick={() => setFormKeamanan({...formKeamanan, enable2FA: !formKeamanan.enable2FA})} className={`w-11 h-6 rounded-full relative transition-colors ${formKeamanan.enable2FA ? "bg-[#2D7D46]" : "bg-gray-300"}`}>
            ...
            {activeTab === "notifikasi" && (
                ...
                <h2 className="text-base font-bold text-gray-900 border-b border-gray-100 pb-3 flex items-center gap-2">
                    <Bell size={18} className="text-[#2D7D46]" /> Pengaturan Saluran Notifikasi
                </h2>
                        ...
                        <tr key={row.key}>
                            ...
                            return (
                                ...
                                <button 
                                    ...
                                    active ? "bg-[#2D7D46] border-[#2D7D46] text-white" : "bg-white border-gray-300"
                                    }`}
                                >
            ...
            {activeTab === "pengiriman" && (
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-5">
                    <h2 className="text-base font-bold text-gray-900 border-b border-gray-100 pb-3 flex items-center gap-2">
                    <MapPin size={18} className="text-[#2D7D46]" /> Detail Penjemputan Paket Kurir
                    </h2>
                    <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1.5">Alamat Lengkap Asal Toko (Untuk Hitung Ongkir)</label>
                    <textarea rows={3} value={formPengiriman.alamatAsal} onChange={e => setFormPengiriman({...formPengiriman, alamatAsal: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 outline-none resize-none" />
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1.5">Kode Pos</label>
                        <input type="text" value={formPengiriman.kodePos} onChange={e => setFormPengiriman({...formPengiriman, kodePos: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 outline-none" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1.5 flex items-center gap-1"><Clock size={14}/> Jam Buka</label>
                        <input type="time" value={formPengiriman.jadwalBuka} onChange={e => setFormPengiriman({...formPengiriman, jadwalBuka: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 outline-none" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1.5 flex items-center gap-1"><Clock size={14}/> Jam Tutup</label>
                        <input type="time" value={formPengiriman.jadwalTutup} onChange={e => setFormPengiriman({...formPengiriman, jadwalTutup: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 outline-none" />
                    </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
                    ...
                    {[
                        ...
                        <div key={k.id} onClick={() => toggleKurir(k.id as any)} className={`flex items-center gap-3 p-3 border rounded-xl cursor-pointer transition-all ${checked ? 'bg-green-50/50 border-green-200' : 'bg-white border-gray-200'}`}>
                            <div className={`w-4 h-4 rounded flex items-center justify-center ${checked ? 'bg-[#2D7D46] text-white' : 'bg-white border border-gray-300'}`}>
            ...
            {activeTab === "kebijakan" && (
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-6 animate-in fade-in duration-200">
                <h2 className="text-base font-bold text-gray-900 border-b border-gray-100 pb-3 flex items-center gap-2">
                    <FileText size={18} className="text-[#2D7D46]" /> Peraturan & Aturan Toko
                </h2>
                <div className="space-y-5">
                    ...
                    <textarea rows={3} value={formKebijakan.catatanToko} onChange={e => setFormKebijakan({...formKebijakan, catatanToko: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 outline-none" />
                    </div>
                    <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1.5">Kebijakan Pengembalian Dana / Retur Barang</label>
                    <textarea rows={3} value={formKebijakan.kebijakanRetur} onChange={e => setFormKebijakan({...formKebijakan, kebijakanRetur: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 outline-none" />
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <input type="number" value={formKebijakan.minOrder} onChange={e => setFormKebijakan({...formKebijakan, minOrder: e.target.value})} className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 outline-none" />
                    </div>
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                type="submit" 
                disabled={isSaving} 
                className="flex items-center gap-2 px-8 py-2.5 bg-[#2D7D46] hover:bg-[#1A4C2E] text-white font-bold text-sm rounded-xl transition-all disabled:opacity-70 shadow-sm"
                >
