    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div>
                {(product.categories as any) && (
                <span className="inline-block text-xs font-semibold text-[#2D7D46] bg-green-50 px-3 py-1 rounded-full mb-3 capitalize">
                    {(product.categories as any).name}
                </span>
                )}
                ...
                <div className="flex items-center gap-3 mb-6 p-3 bg-gray-50 rounded-xl border border-gray-100">
                    <div className="w-9 h-9 rounded-full bg-[#2D7D46]/10 flex items-center justify-center text-[#2D7D46] font-bold text-sm">
