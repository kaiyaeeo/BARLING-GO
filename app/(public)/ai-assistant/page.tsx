    ...
    return (
        ...
        <div className="flex-1 overflow-y-auto">
            ...
            {messages.length === 0 ? (
                ...
                <div className="w-16 h-16 rounded-2xl bg-[#2D7D46]/10 flex items-center justify-center mx-auto mb-4">
                    <Sparkles size={28} className="text-[#2D7D46]" />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg mx-auto">
                    ...
                    return (
                        ...
                        className="flex items-center gap-3 p-3.5 bg-white border border-gray-200 rounded-xl text-left text-sm text-gray-700 hover:border-[#2D7D46] hover:bg-green-50 hover:text-[#2D7D46] transition-all group"
                        >
                        <Icon size={16} className="shrink-0 text-gray-400 group-hover:text-[#2D7D46]" />
                        {s.text}
                        </button>
                    )
                    })}
                ...
                {messages.map((msg, i) => (
                    ...
                    {msg.role === "assistant" && (
                        <div className="w-7 h-7 rounded-lg bg-[#2D7D46] flex items-center justify-center shrink-0 mt-0.5">
                ...
                {loading && (
                    ...
                    <div className="w-7 h-7 rounded-lg bg-[#2D7D46] flex items-center justify-center shrink-0">
                        <Sparkles size={13} className="text-white" />
                    </div>
        ...
        <div className="bg-white border-t border-gray-100 px-4 py-4">
            ...
            <div className="flex gap-3 items-end">
                ...
                <textarea
                    ...
                    rows={1}
                    className="w-full px-4 py-3 pr-12 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46] resize-none leading-relaxed"
                ...
                className="w-11 h-11 bg-[#2D7D46] hover:bg-[#236338] disabled:opacity-40 text-white rounded-xl flex items-center justify-center transition-all shrink-0"
                >
