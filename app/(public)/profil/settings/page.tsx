        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex-1 min-w-0 space-y-5">
                ...
                <div className="flex items-center gap-2 mb-5">
                    <Bell size={17} className="text-[#2D7D46]" />
                ...
                <div className="space-y-4">
                    ...
                    <label key={item.key} className="flex items-center justify-between p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                        ...
                        className={`relative w-11 h-6 rounded-full transition-colors cursor-pointer ${
                            notif[item.key as keyof typeof notif] ? "bg-[#2D7D46]" : "bg-gray-300"
                        }`}
                        >
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                <div className="flex items-center gap-2 mb-5">
                    <Lock size={17} className="text-[#2D7D46]" />
                ...
                <form onSubmit={handleChangePassword} className="space-y-4 max-w-md">
                    ...
                    <div key={f.name}>
                        ...
                        <input
                            ...
                            required
                            className="w-full px-4 py-2.5 pr-10 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46]"
                        />
                        {f.name === "new" && (
                    ...
                    className="px-6 py-2.5 bg-[#2D7D46] hover:bg-[#236338] disabled:opacity-60 text-white text-sm font-semibold rounded-xl flex items-center gap-2 transition-all">
