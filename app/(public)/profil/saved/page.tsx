    ...
    destinasi:  "bg-green-100 text-[#2D7D46]",
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-16 text-center">
                    ...
                    <Link href="/wisata"
                        className="px-5 py-2.5 bg-[#2D7D46] text-white text-sm font-semibold rounded-xl hover:bg-[#236338] transition-all">
                        Jelajahi Wisata
                    </Link>
                    <Link href="/kuliner"
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    return (
                        ...
                        <div className="p-4">
                            ...
                            <h3 className="text-sm font-bold text-gray-900 hover:text-[#2D7D46] transition-colors mb-1">
                                {dest.title}
                            </h3>
                            </Link>
                            {dest.kabupaten && (
                            ...
                            <p className="text-sm font-bold text-[#2D7D46] mt-1.5">
