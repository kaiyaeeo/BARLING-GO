        ...
        <main className="min-h-screen bg-white pt-16">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    {item.kabupaten && <span className="px-3 py-1 bg-green-50 text-[#2D7D46] text-xs font-bold rounded-full">{item.kabupaten}</span>}
                    </div>
                    {item.rating > 0 && (
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-5 sticky top-24">
                    ...
                    {item.phone && (
                        ...
                        className="w-full py-3 bg-[#2D7D46] hover:bg-[#236338] text-white font-bold rounded-xl text-sm flex items-center justify-center gap-2 transition-all">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex justify-between gap-4">
                <div>
