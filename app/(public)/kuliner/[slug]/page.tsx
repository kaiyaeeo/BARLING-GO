        ...
        <main className="min-h-screen bg-white pt-16">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    {item.kabupaten && (
                        <span className="px-3 py-1 bg-green-50 text-[#2D7D46] text-xs font-bold rounded-full">{item.kabupaten}</span>
                    )}
                    </div>
                    {item.rating > 0 && (
                ...
                {related && related.length > 0 && (
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        ...
                        return (
                            ...
                            <p className="text-xs font-semibold text-gray-800 truncate group-hover:text-[#2D7D46]">{r.title}</p>
                            {r.ticket_price_min > 0 && (
                                <p className="text-xs text-[#2D7D46] font-bold mt-0.5">Rp {r.ticket_price_min.toLocaleString("id-ID")}</p>
                            )}
                            </Link>
                        )
                        })}
