    ...
    <style>
        ...
        .logo { font-size: 22px; font-weight: 900; color: #2D7D46; }
        .logo span { color: #111; }
        .invoice-title { font-size: 28px; font-weight: 800; color: #111; margin-bottom: 4px; }
        .badge { display: inline-block; background: #e8f5ee; color: #2D7D46; font-size: 12px; font-weight: 600; padding: 4px 12px; border-radius: 99px; }
        ...
        .total-row td { font-weight: 700; font-size: 15px; color: #2D7D46; padding-top: 12px; }
    ...
    <div class="section" style="margin-top:24px">
        ...
        <p style="margin:4px 0 0;font-size:13px;color:${order.payment_status === "paid" ? "#2D7D46" : "#F59E0B"};font-weight:600">
