    ...
    const stats = [
    { value: "8k+", label: "Kisah Seru dari", sub: "Pengguna Kami" },
    { value: "3thn", label: "Pengalaman Wisata", sub: "yang Terpercaya" },
    { value: "50+", label: "Jelajahi Destinasi", sub: "Barlingmascakep" },
    ]
    ...
    const features = [
    {
        ...
        title: "Kuliner",
        desc: "Cari tempat makan paling hits dan legendaris di sekitamu.",
        color: "bg-orange-50",
    ...
    },
    {
        icon: Map,
        title: "Wisata",
        desc: "Rencanakan petualanganmu berikutnya dengan rute terbaik.",
        color: "bg-blue-50",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-3">
                ...
                return (
                    <div
                    key={f.title}
                    className={`flex items-center gap-4 p-4 rounded-2xl ${f.color} border border-gray-100 hover:shadow-md transition-all cursor-pointer group`}
                    >
