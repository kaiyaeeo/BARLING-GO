    ...
    const bgImage = hero.image_url
        ?? "https://images.unsplash.com/photo-1588392382834-a891154bca4d?w=1600&q=80"
    ...
    return (
        ...
        <div className="absolute top-32 right-8 lg:right-16 hidden md:block">
            ...
            <p className="text-xs text-green-200 font-semibold uppercase tracking-wider mb-3">Selamat Datang di Wisata Alam Banyumas</p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 w-full">
            ...
            <div className="flex flex-wrap gap-3">
                <Link href="/ai-assistant" className="inline-flex items-center gap-2 px-6 py-3 bg-[#FF6B35] hover:bg-[#e5592a] text-white font-semibold rounded-xl text-sm transition-all hover:scale-105 shadow-lg shadow-orange-900/30">
                <Sparkles size={16} /> Plan Your Trip
                </Link>
                <Link href="/wisata" className="inline-flex items-center gap-2 px-6 py-3 bg-white/15 hover:bg-white/25 backdrop-blur-sm text-white font-semibold rounded-xl text-sm transition-all border border-white/30">
                Explore Destination
                </Link>
            </div>
            </div>
