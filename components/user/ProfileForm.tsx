        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 lg:p-6">
            ...
            <div>
                ...
                <input
                    ...
                    className="flex-1 px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46]"
                />
                </div>
            </div>
            ...
            {PREFERENCE_TAGS.map((tag) => {
                ...
                <button
                    ...
                    active
                        ...
                        : "bg-white text-gray-600 border-gray-200 hover:border-[#2D7D46] hover:text-[#2D7D46]"
                    }`}
                >
                    {tag.label}
                </button>
        ...
        <div className="flex items-center justify-between pt-1">
            ...
            <button
                ...
                saved
                    ...
                    : "bg-[#2D7D46] hover:bg-[#236338] text-white disabled:opacity-60"
                }`}
            >
