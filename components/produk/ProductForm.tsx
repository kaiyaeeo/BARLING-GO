    ...
    return (
        ...
        <div className="bg-white border-b border-gray-100 pt-20 pb-6">
            ...
            <form method="GET" className="flex gap-3 mb-5">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46] bg-gray-50"
                />
                </div>
                {type !== "all" && <input type="hidden" name="type" value={type} />}
                <button type="submit" className="px-5 py-2.5 bg-[#2D7D46] text-white text-sm font-medium rounded-xl hover:bg-[#236338] transition-all">
                Cari
                </button>
            </form>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="text-center py-20 text-gray-400">
                ...
                <Link href="/produk" className="mt-4 inline-block text-sm text-[#2D7D46] hover:underline">Reset filter</Link>
            </div>
            ) : (
            <>
                ...
                {products.map((item: any) => {
                    ...
                    <Link key={item.id} href={`/produk/${item.slug}`} className="group bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-md transition-all">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {discounted ? (
                                <div>
                                <span className="text-[#2D7D46] font-bold text-sm">
