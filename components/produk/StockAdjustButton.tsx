    ...
    return (
        <>
        <button onClick={() => setOpen(true)} className="p-1.5 text-gray-400 hover:text-[#2D7D46] hover:bg-green-50 rounded-lg transition-all">
            <Edit2 size={13} />
        </button>
                ...
                <div>
                    ...
                    {[
                        ...
                        className={`py-2 text-xs font-semibold rounded-xl border transition-all ${
                            type === t.value ? "bg-[#2D7D46] text-white border-[#2D7D46]" : "border-gray-200 text-gray-600 hover:border-gray-400"
                        }`}
                        >
                        {t.label}
                        </button>
