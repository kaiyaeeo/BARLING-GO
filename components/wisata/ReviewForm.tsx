    ...
    return (
        ...
        <div>
            ...
            className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46] resize-none"
            />
        </div>
        ...
        <button
            type="submit"
            disabled={loading}
            className="flex items-center gap-2 px-5 py-2.5 bg-[#2D7D46] hover:bg-[#236338] disabled:opacity-60 text-white text-sm font-semibold rounded-xl transition-all"
        >
