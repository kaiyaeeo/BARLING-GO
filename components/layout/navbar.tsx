    ...
    return (
            ...
            <div className="hidden md:flex items-center gap-2">
                ...
                <>
                    ...
                    >
                        ...
                        <div className="w-7 h-7 rounded-lg bg-[#2D7D46] flex items-center justify-center text-white text-xs font-bold">{initials}</div>
                        )}
                ...
                <Link
                    href="/login"
                    className="ml-1 px-5 py-2 text-sm font-bold text-white bg-[#2D7D46] hover:bg-[#236338] rounded-xl transition-all"
                >
                    Login
                </Link>
                )}
        ...
        {mobileOpen && (
            ...
            {user ? (
                ...
                <Link href={dashboardHref} className="block py-2.5 text-sm font-semibold text-[#2D7D46] text-center border border-[#2D7D46] rounded-xl">Dashboard</Link>
                ...
                <Link href="/login" className="mt-3 block text-center py-2.5 text-sm font-bold text-white bg-[#2D7D46] rounded-xl">Login</Link>
            )}
            </div>
        )}
        </header>
