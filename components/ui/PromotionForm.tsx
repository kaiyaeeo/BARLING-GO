    ...
    return (
        ...
        {[
            ...
            <input name={f.name} value={(form as any)[f.name]} onChange={handleChange} required
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46] font-mono" />
            </div>
        ))}
        <div className="grid grid-cols-2 gap-3">
            ...
            <select name="type" value={form.type} onChange={handleChange}
                className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 bg-white">
        ...
        <div className="grid grid-cols-2 gap-3">
            ...
            <input type="number" name="min_purchase" value={form.min_purchase} onChange={handleChange} min="0" placeholder="0"
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30" />
            </div>
            <div>
        ...
        <label className="flex items-center gap-2 cursor-pointer">
            <input type="checkbox" name="is_active" checked={form.is_active} onChange={handleChange} className="accent-[#2D7D46]" />
            <span className="text-sm text-gray-700">Langsung aktifkan</span>
        </label>
        <button type="submit" disabled={loading}
            className="w-full py-3 bg-[#2D7D46] hover:bg-[#236338] disabled:opacity-60 text-white font-semibold rounded-xl text-sm flex items-center justify-center gap-2">
