    ...
    return (
        ...
        <div className="relative overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-sm">
            <div className="h-24 md:h-28 bg-gradient-to-r from-[#1A4C2E] via-[#2D7D46] to-[#3FA15E]" />
            ...
            <div className="relative shrink-0">
                ...
                disabled={uploading}
                className="absolute -bottom-2 -right-2 w-9 h-9 rounded-full bg-[#2D7D46] text-white flex items-center justify-center shadow-md hover:bg-[#236338] hover:scale-105 active:scale-95 transition-all"
            ...
            <div className="flex-1 min-w-0">
                ...
                <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-green-50 text-[#2D7D46] text-xs font-semibold border border-green-100">
        ...
        <div className="bg-white p-5 md:p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row md:items-center gap-4">
            ...
            <div className="w-10 h-10 rounded-xl bg-green-50 flex items-center justify-center text-[#2D7D46]">
                <ShieldCheck size={20} />
            </div>
            <div>
            ...
            <div className="flex-1 h-2.5 rounded-full bg-gray-100 overflow-hidden">
                <div
                className="h-full rounded-full bg-gradient-to-r from-[#2D7D46] to-[#3FA15E] transition-all duration-500"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-5">
                ...
                <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46] transition-all resize-none"
            ...
            <div className="space-y-5">
                ...
                <div>
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46] bg-white transition-all"
                    >
            ...
            <div className="pt-5 border-t border-gray-100 mt-auto">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46] transition-all"
                        placeholder="08..."
                    />
                    </div>
                </div>
        ...
        <div className="flex justify-end pt-1">
            ...
            className={`px-10 py-3.5 font-bold rounded-2xl text-sm md:text-base flex items-center gap-2 transition-all shadow-md hover:shadow-lg active:scale-[0.98] ${
                saved ? "bg-[#2D7D46] text-white" : "bg-[#2D7D46] hover:bg-[#236338] text-white disabled:opacity-60"
            }`}
            >
        ...
        <div className="relative overflow-hidden rounded-3xl shadow-xl bg-gradient-to-br from-gray-900 via-[#11301d] to-[#1A4C2E] text-white p-8 md:p-10">
