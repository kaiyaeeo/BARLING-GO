    ...
    return (
        ...
        {data.map((stat) => (
            ...
            <div>
                ...
                className="w-full px-3 py-2 text-sm rounded-lg border border-gray-200 focus:outline-none focus:ring-1 focus:ring-[#2D7D46]" />
            </div>
            <div>
        ...
        <button onClick={handleSave} disabled={saving || saved}
            className={`px-6 py-2.5 text-sm font-semibold rounded-xl flex items-center gap-2 transition-all ${saved ? "bg-green-500 text-white" : "bg-[#2D7D46] hover:bg-[#236338] text-white disabled:opacity-60"}`}>
    ...
    return (
        ...
        <div>
            ...
            rows={2} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46] resize-none" />
        </div>
        <div>
