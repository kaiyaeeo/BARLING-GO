    ...
    return (
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-6">
            ...
            <div className="w-8 h-8 rounded-lg bg-green-50 text-[#2D7D46] flex items-center justify-center">
                <Wallet size={16} />
            </div>
            ...
            <div className="relative">
                <input type="text" value={formBayar.komisi} onChange={e => setFormBayar({...formBayar, komisi: e.target.value})} className="w-full pl-4 pr-10 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 focus:border-[#2D7D46] outline-none" />
            ...
            <div className="relative">
                ...
                <input type="text" value={formBayar.biayaLayanan} onChange={e => setFormBayar({...formBayar, biayaLayanan: e.target.value})} className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 focus:border-[#2D7D46] outline-none" />
            </div>
            ...
            <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 text-sm font-medium">Rp</span>
                <input type="text" value={formBayar.minPenarikan} onChange={e => setFormBayar({...formBayar, minPenarikan: e.target.value})} className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 focus:border-[#2D7D46] outline-none" />
            </div>
            </div>
            ...
            <button type="button" onClick={() => setFormBayar({...formBayar, isPpnActive: !formBayar.isPpnActive})} className={`w-11 h-6 rounded-full relative transition-colors ${formBayar.isPpnActive ? "bg-[#2D7D46]" : "bg-gray-300"}`}>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-6">
            <div className="flex items-center gap-3 border-b border-gray-100 pb-4">
            <div className="w-8 h-8 rounded-lg bg-[#2D7D46]/10 text-[#2D7D46] flex items-center justify-center">
                <Server size={16} />
            </div>
            ...
            <select value={formBayar.provider} onChange={e => setFormBayar({...formBayar, provider: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 focus:border-[#2D7D46] outline-none appearance-none bg-white">
            ...
            <input type="text" value={formBayar.clientKey} onChange={e => setFormBayar({...formBayar, clientKey: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 focus:border-[#2D7D46] outline-none font-mono text-gray-600" />
            </div>

            <div>
            <label className="block text-sm font-semibold text-gray-800 mb-1">Server Key</label>
            <input type="password" value={formBayar.serverKey} onChange={e => setFormBayar({...formBayar, serverKey: e.target.value})} className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#2D7D46]/20 focus:border-[#2D7D46] outline-none font-mono text-gray-600" />
            </div>
            ...
            <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">Status saat ini: <span className={formBayar.isProduction ? "text-[#2D7D46] font-semibold" : "text-amber-600 font-semibold"}>{formBayar.isProduction ? "Production" : "Sandbox"}</span></p>
            </div>
            <button type="button" onClick={() => setFormBayar({...formBayar, isProduction: !formBayar.isProduction})} className={`w-11 h-6 rounded-full relative transition-colors ${formBayar.isProduction ? "bg-[#2D7D46]" : "bg-gray-300"}`}>
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                <div className={`w-5 h-5 rounded flex items-center justify-center transition-colors ${formBayar.methods.va ? 'bg-[#2D7D46] text-white' : 'bg-white border border-gray-300'}`}>
                ...
                <div className={`w-5 h-5 rounded flex items-center justify-center transition-colors ${formBayar.methods.qris ? 'bg-[#2D7D46] text-white' : 'bg-white border border-gray-300'}`}>
                ...
                <div className={`w-5 h-5 rounded flex items-center justify-center transition-colors ${formBayar.methods.ewallet ? 'bg-[#2D7D46] text-white' : 'bg-white border border-gray-300'}`}>
                ...
                <div className={`w-5 h-5 rounded flex items-center justify-center transition-colors ${formBayar.methods.creditCard ? 'bg-[#2D7D46] text-white' : 'bg-white border border-gray-300'}`}>
        ...
        <div className="md:col-span-2 flex justify-end gap-3 mt-2">
            ...
            <button type="submit" disabled={isSaving} className="flex items-center gap-2 px-6 py-2.5 bg-[#2D7D46] hover:bg-[#1A4C2E] text-white font-semibold text-sm rounded-xl transition-all disabled:opacity-70">
