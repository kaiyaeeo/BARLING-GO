    ...
    return (
        <aside className="fixed top-0 left-0 h-full w-52 bg-[#1a3a22] z-40 flex flex-col">
        {/* Logo */}
        <div className="flex flex-col px-5 pt-5 pb-4 border-b border-white/10">
            ...
            <span className="text-xs text-green-300/60 mt-0.5">Regional Tourism</span>
        </div>
        ...
        <div className="border-t border-white/10 p-3">
            ...
            <div className="min-w-0">
                ...
                <p className="text-[10px] text-green-300/60">Super Admin Access</p>
            </div>
            </div>
            <button
