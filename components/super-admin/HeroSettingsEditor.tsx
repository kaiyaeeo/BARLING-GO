    ...
    return (
        ...
        <h2 className="text-lg font-bold text-gray-900 mb-5 flex items-center gap-2">
            <ImageIcon size={20} className="text-[#2D7D46]" />
        ...
        <div className="space-y-5">
            ...
            <input 
                type="text" 
                className="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#2D7D46]/30 focus:border-[#2D7D46] outline-none transition-all" 
            ...
            <button 
                type="submit" 
                disabled={loading} 
                className="flex items-center gap-2 px-6 py-2.5 bg-[#2D7D46] hover:bg-[#236338] text-white font-bold rounded-xl transition-all disabled:opacity-70"
            >
