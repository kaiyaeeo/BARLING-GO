    ...
    return (
        ...
        {open && (
            ...
            style={{ height: "420px" }}>
            {/* Header */}
            <div className="flex items-center gap-2.5 px-4 py-3 bg-[#2D7D46] shrink-0">
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-3">
                ...
                <div className="text-center pt-4">
                    ...
                    <button key={s} onClick={() => { setInput(s); sendMessage() }}
                        className="block w-full text-left text-xs px-3 py-2 bg-gray-50 hover:bg-green-50 hover:text-[#2D7D46] rounded-lg mb-1.5 transition-colors">
                        {s}
                    </button>
                    ))}
                </div>
            ...
            <div className="flex gap-2 p-3 border-t border-gray-100 shrink-0">
                ...
                className="flex-1 px-3 py-2 text-xs rounded-lg border border-gray-200 focus:outline-none focus:ring-1 focus:ring-[#2D7D46]"
                />
                <button onClick={sendMessage} disabled={!input.trim() || loading}
                className="w-8 h-8 bg-[#2D7D46] disabled:opacity-40 text-white rounded-lg flex items-center justify-center">
            ...
            <div className="px-3 pb-2 shrink-0">
                <Link href="/ai-assistant" className="text-[10px] text-[#2D7D46] hover:underline">
        ...
        <button
            ...
            className="w-14 h-14 bg-[#2D7D46] hover:bg-[#236338] text-white rounded-2xl flex items-center justify-center shadow-lg shadow-green-900/30 transition-all hover:scale-105"
        >
